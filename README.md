...
```
go get github.com/Unity-Technologies/goreportcard
```

Go into the source directory and pull down the project dependencies:

```
cd $GOPATH/src/github.com/Unity-Technologies/goreportcard
make install
```
...
Example usage:
```
go get github.com/Unity-Technologies/goreportcard/cmd/goreportcard-cli
cd $GOPATH/src/github.com/Unity-Technologies/goreportcard
goreportcard-cli
```
...
Go Report Card is an open source project run by volunteers, and contributions are welcome! Check out the [Issues](https://github.com/Unity-Technologies/goreportcard/issues) page to see if your idea for a contribution has already been mentioned, and feel free to raise an issue or submit a pull request.
